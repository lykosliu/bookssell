...
import com.phelps.goodssell.service.ISmsRecordInfoService;
import com.phelps.goodssell.entity.SmsRecordInfo;
 ...
 */
@RestController
@RequestMapping("/smsRecordInfo")
public class SmsRecordInfoController extends BaseController {
    @Autowired
    private ISmsRecordInfoService service;
    /**
     * 实体查询
     */
    ...
    public ResponseVO add(@RequestBody SmsRecordInfo entity) {
    ...
    @RequestMapping(value = "{id}", method = RequestMethod.PUT)
        public ResponseVO update(@PathVariable Long id,@RequestBody SmsRecordInfo entity) {
        entity.setId(id);
    ...
    public ResponseVO selectPage(Page<SmsRecordInfo> page) {
