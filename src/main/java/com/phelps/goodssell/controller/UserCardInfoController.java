...
import com.phelps.goodssell.service.IUserCardInfoService;
import com.phelps.goodssell.entity.UserCardInfo;
 ...
 */
@RestController
@RequestMapping("/userCardInfo")
public class UserCardInfoController extends BaseController {
    @Autowired
    private IUserCardInfoService service;
    /**
     * 实体查询
     */
    ...
    public ResponseVO add(@RequestBody UserCardInfo entity) {
    ...
    @RequestMapping(value = "{id}", method = RequestMethod.PUT)
        public ResponseVO update(@PathVariable Long id,@RequestBody UserCardInfo entity) {
        entity.setId(id);
    ...
    public ResponseVO selectPage(Page<UserCardInfo> page) {
