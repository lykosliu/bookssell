...
import com.phelps.goodssell.service.IGoodsInfoService;
import com.phelps.goodssell.entity.GoodsInfo;
...
public class GoodsInfoController extends BaseController {
    ...
    public ResponseVO add(@RequestBody GoodsInfo entity) {
    ...
    @RequestMapping(value = "{id}", method = RequestMethod.PUT)
        public ResponseVO update(@PathVariable Long id,@RequestBody GoodsInfo entity) {
        entity.setId(id);
    ...
    public ResponseVO selectPage(Page<GoodsInfo> page) {
