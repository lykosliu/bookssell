...
import com.phelps.goodssell.service.IAdminInfoService;
import com.phelps.goodssell.entity.AdminInfo;
...
public class AdminInfoController extends BaseController {
    ...
    public ResponseVO add(@RequestBody AdminInfo entity) {
    ...
    @RequestMapping(value = "{id}", method = RequestMethod.PUT)
        public ResponseVO update(@PathVariable Long id,@RequestBody AdminInfo entity) {
        entity.setId(id);
    ...
    public ResponseVO selectPage(Page<AdminInfo> page) {
