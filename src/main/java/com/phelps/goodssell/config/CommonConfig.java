package com.phelps.goodssell.config;
...
@Configuration
@EnableSwagger2
@ComponentScan("com.vipabc.basic.common.util.partdb")
public class CommonConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.phelps.goodssell.controller"))
